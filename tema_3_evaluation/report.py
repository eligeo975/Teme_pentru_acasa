    ...
    <div class="card">
        ...
        <div class="scores-row">
            <div class="score-box" style="border-color:{c1}">
                <div class="score-label">Relevanță Legislație</div>
            ...
            <div class="score-box" style="border-color:{c2}">
                <div class="score-label">Fără Bias</div>
...
<head>
    ...
    <title>Raport Evaluare — Asistent Legislatie</title>
...
<div class="container">
    ...
    <div class="footer">Asistent Legislatie — Evaluation Report</div>
</div>
<script>
